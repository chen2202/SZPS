 ...
 */
@Controller
@RequestMapping("/op/dev/bosupplier")
public class BOSupplierController extends BaseController {
	 @Autowired
	private IYearAppraisalService service;
	
	private String prefix = "/dev/bo/supplier";
	
    @RequiresPermissions("dev:bosupplier:view")
    @GetMapping()
    public String view()
    {
        return prefix + "/view";
    ...
    @RequiresPermissions("dev:bosupplier:add")
    ...
    @RequiresPermissions("dev:bosupplier:edit")
    @PostMapping("/edit")
    @ResponseBody
    ...
    @RequiresPermissions("dev:bosupplier:delete")
