...
public interface SysMenuMapper
{
    ...
    public List<SysMenu> selectMenusByUserIdAndSubsysFlag(@Param("userId")Long userId,@Param("subsysFlag")String subsysFlag);
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenusByByUserIdAndType(SysUser user, String type) ;
