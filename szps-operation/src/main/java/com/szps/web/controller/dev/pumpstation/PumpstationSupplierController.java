 ...
 */
@Controller
@RequestMapping("/op/dev/pumpstationsupplier")
public class PumpstationSupplierController extends BaseController {
	 @Autowired
	private IYearAppraisalService service;
	
	private String prefix = "/dev/pumpstation/supplier";
	
    @RequiresPermissions("dev:pumpstationsupplier:view")
    @GetMapping()
    public String view()
    {
        return prefix + "/view";
    ...
    @RequiresPermissions("dev:pumpstationsupplier:add")
    ...
    @RequiresPermissions("dev:pumpstationsupplier:edit")
    @PostMapping("/edit")
    @ResponseBody
    ...
    @RequiresPermissions("dev:pumpstationsupplier:delete")
