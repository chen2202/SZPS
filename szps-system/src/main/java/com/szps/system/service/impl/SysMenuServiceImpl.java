...
import com.szps.system.mapper.SysMenuMapper;
import com.szps.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
	...
	@Override
	public List<SysMenu> selectMenusByUserAndSubsysFlag(SysUser user, String subsysFlag,Integer parentId) {
		List<SysMenu> menus = new LinkedList<SysMenu>();
        // 管理员显示所有菜单信息
        if (user.isAdmin())
        {
        ...
        {
            menus = menuMapper.selectMenusByUserIdAndSubsysFlag(user.getUserId(),subsysFlag);
        }
