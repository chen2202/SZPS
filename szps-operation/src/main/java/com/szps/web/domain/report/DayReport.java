...
import com.szps.common.utils.excel.annotation.ExcelField.ExcelField;
...
//	/颜色
	...
	@ExcelField(title = "天气", type = 1, align = 2, sort = 3)
	public String getWeather() {
		return weather;
	}

	@ExcelField(title = "日处理水量(m3)", type = 1, align = 2, sort = 4)
	public String getDwt1() {
		return dwt1;
	}

	@ExcelField(title = "日处理水量(m3)", type = 1, align = 2, sort = 5)
	public String getDwt2() {
		return dwt2;
	}

	@ExcelField(title = "污泥量（吨）", type = 1, align = 2, sort = 6)
	public String getSq1() {
		return sq1;
	}

	@ExcelField(title = "用电量(kw.h)", type = 1, align = 2, sort = 7)
	public String getElectricity() {
		return electricity;
	}

	@ExcelField(title = "用水量（吨）", type = 1, align = 2, sort = 8)
	public String getWater() {
		return water;
	}

	@ExcelField(title = "PAC（吨）", type = 1, align = 2, sort = 9)
	public String getPac() {
		return pac;
	}

	@ExcelField(title = "铁盐/除磷剂（吨）", type = 1, align = 2, sort = 10)
	public String getIpra() {
		return ipra;
	}

	@ExcelField(title = "PAM-(kg)", type = 1, align = 2, sort = 11)
	...
	@ExcelField(title = "COD", type = 1, align = 2, sort = 15)
	public String getCod2() {
		return cod2;
	}

	@ExcelField(title = "氨氮", type = 1, align = 2, sort = 16)
	public String getAn1() {
		return an1;
	}

	@ExcelField(title = "氨氮", type = 1, align = 2, sort = 17)
	public String getAn2() {
		return an2;
	}

	@ExcelField(title = "TN", type = 1, align = 2, sort = 18)
	public String getTn1() {
		return tn1;
	}

	@ExcelField(title = "TN", type = 1, align = 2, sort = 19)
	public String getTn2() {
		return tn2;
	}

	@ExcelField(title = "TP", type = 1, align = 2, sort = 20)
	public String getTp1() {
		return tp1;
	}

	@ExcelField(title = "TP", type = 1, align = 2, sort = 21)
	public String getTp2() {
		return tp2;
	}

	@ExcelField(title = "沉淀池SS", type = 1, align = 2, sort = 22)
	public void getStss1(String stss1) {
		this.stss1 = stss1;
	}

	@ExcelField(title = "沉淀池TP", type = 1, align = 2, sort = 23)
	public String getSttp1() {
		return sttp1;
	}

	@ExcelField(title = "SV30（%", type = 1, align = 2, sort = 24)
	public String getSv30() {
		return sv30;
	}

	@ExcelField(title = "污泥浓度（g/L）", type = 1, align = 2, sort = 25)
	public String getSludge() {
		return sludge;
	}

	@ExcelField(title = "溶解氧（mg/L）", type = 1, align = 2, sort = 26)
	public String getOxygen() {
		return oxygen;
	}

	@ExcelField(title = "混合液回流比（%）", type = 1, align = 2, sort = 27)
	public String getMixture() {
		return mixture;
	}

	@ExcelField(title = "污泥回流比（%）", type = 1, align = 2, sort = 28)
	public String getReflux() {
		return reflux;
	}

	@ExcelField(title = "养护情况", type = 1, align = 2, sort = 29)
	public String getConditionDesc() {
		return conditionDesc;
	}

	@ExcelField(title = "≦60", type = 1, align = 2, sort = 30)
	public String getLt60() {
		return lt60;
	}

	@ExcelField(title = "60-120", type = 1, align = 2, sort = 31)
	public String getG6l12() {
		return g6l12;
	}

	@ExcelField(title = "120-180", type = 1, align = 2, sort = 32)
	public String getG12l18() {
		return g12l18;
	}

	@ExcelField(title = "180以上", type = 1, align = 2, sort = 33)
	 ...
	 */
	@ExcelField(title = "厂区", type = 1, align = 2, sort = 2)
