...
public class PsProgressController extends BaseController {
	 @Autowired
	private IPsProgressService service;
    ...
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(PsProgress obj)
    {
        startPage();
        List<PsProgress> list = service.selectList(obj);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave( PsProgress obj)
    {
    ...
    {
    	PsProgress obj = service.selectById(id);
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated PsProgress obj)
    {
