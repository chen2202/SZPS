package com.szps.common.utils.file;
...
import com.szps.common.exception.file.FileNameLengthLimitExceededException;
import com.szps.common.exception.file.FileSizeLimitExceededException;
import com.szps.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils
{
    ...
    public static final String upload2(String baseDir, MultipartFile file,String type) throws IOException
    {
        try
        {
            return type + File.separator+upload2(baseDir, file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
