package com.szps.framework.config;
...
import com.szps.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.szps.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.szps.framework.shiro.web.session.OnlineWebSessionManager;
import com.szps.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("szps");
